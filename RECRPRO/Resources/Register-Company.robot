...
# When registration is success, this variables need to be updated with new unregistered email.
# (Update this variable when needed)
${regCompanyName}                   PDW52 COMPANY
${regName}                          POPPY52
${regEmail}                         POPPY524@MAILINATOR.COM
${regPassword}                      !1Qazqaz

#Verified Registered Company Account
${Email}                            BEA02@MAILINATOR.COM
${Password}                         !1Qazqaz
...
# Valid data for new company registration (Update this variable when needed)
${rregCompanyName}                  PhilHarmonic505G Co.
${rregName}                         Philip505G
${rregEmail}                        Philip505G@MAILINATOR.COM
...
${ShowPass-RegEmail}                Monic405da@MAILINATOR.COM
...
Click Create Account
    Click Button                    //*[@id="reg-create-account"]
Sign In With Google
